...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.synced_folder "./puppet/manifests", "/etc/puppet/manifests/", :mount_options => ["dmode=777,fmode=777"]
  config.vm.synced_folder "./puppet/modules", "/etc/puppet/modules/", :mount_options => ["dmode=777,fmode=777"]
